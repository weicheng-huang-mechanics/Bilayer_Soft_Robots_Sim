...
elasticTwistingForce::elasticTwistingForce(const std::shared_ptr<elasticPlate> m_plate,
...
elasticTwistingForce::~elasticTwistingForce() = default;

void elasticTwistingForce::computeForceAndJacobian()
{
    computeFt();
    computeJt();
}
