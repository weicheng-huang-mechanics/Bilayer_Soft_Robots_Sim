...
elasticBendingForce::elasticBendingForce(const std::shared_ptr<elasticPlate> m_plate, 
...
{    
    ...
    gradKappa1 = MatrixXd::Zero(plate->bendingNum,11);
    gradKappa2 = MatrixXd::Zero(plate->bendingNum,11);
...
void elasticBendingForce::computeForceAndJacobian()
{
    computeFb();
    computeJb();
}
