...
elasticStretchingForce::elasticStretchingForce(const std::shared_ptr<elasticPlate> m_plate, 
...
elasticStretchingForce::~elasticStretchingForce() = default;

void elasticStretchingForce::computeForceAndJacobian()
{
	computeFs();
	computeJs();
}
