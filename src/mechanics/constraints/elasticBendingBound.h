...
class elasticBendingBound : public BaseForce
{
public:
	elasticBendingBound(const std::shared_ptr<elasticPlate> m_plate, const std::shared_ptr<timeStepper> m_stepper);
	~elasticBendingBound() override;
